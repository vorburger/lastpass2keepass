...
As an alternative to this script, you can also use manual steps through CSV export and re-import, as described e.g. in this blog post: http://blog2.vorburger.ch/2016/06/how-to-migrate-from-lastpass-to-keepass.html
